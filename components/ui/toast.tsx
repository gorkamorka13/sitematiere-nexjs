...
export function Toast({ message, type, onClose, duration = 5000 }: ToastProps) {
    ...
    return (
        <div
            className={`fixed top-6 right-6 z-[200] flex items-center gap-3 px-6 py-4 rounded-xl shadow-2xl backdrop-blur-sm border-2 animate-in slide-in-from-top-5 fade-in duration-300 ${isSuccess
