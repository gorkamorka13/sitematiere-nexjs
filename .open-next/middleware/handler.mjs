...
var require_dist2 = __commonJS({
  "node_modules/path-to-regexp/dist/index.js"(exports) {
    ...
    function compile2(path3, options = {}) {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function bt(a10) {
        let b2 = a10.cookies, c2 = b2.get("authjs.session-token")?.value || b2.get("__Secure-authjs.session-token")?.value || b2.get("__Host-authjs.session-token")?.value || b2.get("next-auth.session-token")?.value || b2.get("__Secure-next-auth.session-token")?.value, d2 = "/login" === a10.nextUrl.pathname;
        return (console.log("[Middleware] Path:", a10.nextUrl.pathname), console.log("[Middleware] All cookies:", Array.from(b2.getAll()).map((a11) => a11.name)), console.log("[Middleware] Session found:", !!c2), c2 || d2) ? c2 && d2 ? (console.log("[Middleware] Redirecting to home - has session"), S.redirect(new URL("/", a10.url))) : S.next() : (console.log("[Middleware] Redirecting to login - no session"), S.redirect(new URL("/login", a10.url)));
      }
      ...
      let bu = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*)"] };
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*))(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": { "NEXT_PUBLIC_APP_VERSION": "0.1.78", "NEXT_PUBLIC_GIT_COMMIT": "e3c2aa9", "NEXT_PUBLIC_BUILD_DATE": "18/02/2026", "NEXT_PUBLIC_CREDIT": "Michel ESPARSA", "NEXT_PUBLIC_R2_PUBLIC_URL": "https://pub-78c42489fd854dc3a6975810aa00edf2.r2.dev" }, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "maximumResponseBody": 5e7, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [{ "protocol": "https", "hostname": "sitematiere-nexjs.pages.dev", "pathname": "**" }, { "protocol": "https", "hostname": "pub-78c42489fd854dc3a6975810aa00edf2.r2.dev", "pathname": "**" }, { "protocol": "https", "hostname": "res.cloudinary.com", "pathname": "**" }], "unoptimized": true }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "C:\\wamp64\\www\\sitematiere-nexjs", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 3, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "middlewareClientMaxBodySize": 10485760, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "serverExternalPackages": ["@aws-sdk/client-s3", "@aws-sdk/s3-request-presigner", "@smithy/util-stream"], "turbopack": { "root": "C:\\wamp64\\www\\sitematiere-nexjs" } };
var BuildId = "RpmSqsQUmpOw8cCVj9eCq";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/export-db", "regex": "^/export\\-db(?:/)?$", "routeKeys": {}, "namedRegex": "^/export\\-db(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [{ "page": "/api/auth/[...nextauth]", "regex": "^/api/auth/(.+?)(?:/)?$", "routeKeys": { "nxtPnextauth": "nxtPnextauth" }, "namedRegex": "^/api/auth/(?<nxtPnextauth>.+?)(?:/)?$" }, { "page": "/api/files/serve/[...key]", "regex": "^/api/files/serve/(.+?)(?:/)?$", "routeKeys": { "nxtPkey": "nxtPkey" }, "namedRegex": "^/api/files/serve/(?<nxtPkey>.+?)(?:/)?$" }, { "page": "/api/files/[id]", "regex": "^/api/files/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/files/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/projects/[id]", "regex": "^/projects/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/projects/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/slideshow/view/[projectId]", "regex": "^/slideshow/view/([^/]+?)(?:/)?$", "routeKeys": { "nxtPprojectId": "nxtPprojectId" }, "namedRegex": "^/slideshow/view/(?<nxtPprojectId>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "0384bf289755926895b100b559a0957b", "previewModeSigningKey": "ce191a2a20fdaccc5855ccfe728281005ab7d0da735fc55067bac21f7d44e3e6", "previewModeEncryptionKey": "b8f6df162c0035e8c4326c3aa0980b0e34101d536339dd5fbfc3483f37170bbf" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "RpmSqsQUmpOw8cCVj9eCq", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "pZDYmp9/kfhaZUmYgTuvDzY8zzHQrRk/R8MYHMSNp50=", "__NEXT_PREVIEW_MODE_ID": "0384bf289755926895b100b559a0957b", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "ce191a2a20fdaccc5855ccfe728281005ab7d0da735fc55067bac21f7d44e3e6", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "b8f6df162c0035e8c4326c3aa0980b0e34101d536339dd5fbfc3483f37170bbf" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/blob-proxy/route": "/api/blob-proxy", "/api/blob-url/route": "/api/blob-url", "/api/create-user/route": "/api/create-user", "/api/debug/auth/route": "/api/debug/auth", "/api/debug/health/route": "/api/debug/health", "/api/files/[id]/route": "/api/files/[id]", "/api/files/bulk-move/route": "/api/files/bulk-move", "/api/files/delete/route": "/api/files/delete", "/api/files/list/route": "/api/files/list", "/api/files/rename/route": "/api/files/rename", "/api/files/restore/route": "/api/files/restore", "/api/files/serve/[...key]/route": "/api/files/serve/[...key]", "/api/files/statistics/route": "/api/files/statistics", "/api/files/upload/route": "/api/files/upload", "/api/projects/route": "/api/projects", "/api/proxy/route": "/api/proxy", "/api/users/route": "/api/users", "/api/debug/route": "/api/debug", "/(auth)/login/page": "/login", "/projects/[id]/page": "/projects/[id]", "/page": "/", "/slideshow/view/[projectId]/page": "/slideshow/view/[projectId]", "/export-db/page": "/export-db" };
...
var import_path_to_regexp = __toESM(require_dist2(), 1);
