...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function bt(a10) {
        let b2 = a10.cookies.get("next-auth.session-token-v2")?.value, c2 = "/login" === a10.nextUrl.pathname;
        return b2 || c2 ? b2 && c2 ? S.redirect(new URL("/", a10.url)) : S.next() : S.redirect(new URL("/login", a10.url));
      }
