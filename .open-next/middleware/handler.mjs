...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico|markers|images|public|export-db|.*\\.png$|.*\\.jpg$|.*\\.jpeg$|.*\\.svg$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "IWmGMO8aVPMBNsPc7TWd2", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "4ksC+9KxOTdL0S8ujgX3JfuilRXG1wLxKYxK75CGvdY=", "__NEXT_PREVIEW_MODE_ID": "e44535b8a676a4d190b1fc21a4c897b9", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "54da92861d4d55c9092a1921355d6b7e7d524271d10d704e84a7d59e798edb74", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "4d6a3a75c98ea867fa159466abafd20aa287c21e9974f8ca1b7e9419b68f5b94" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/blob-url/route": "/api/blob-url", "/api/blob-proxy/route": "/api/blob-proxy", "/api/debug/auth/route": "/api/debug/auth", "/api/create-user/route": "/api/create-user", "/api/debug/health/route": "/api/debug/health", "/api/files/bulk-move/route": "/api/files/bulk-move", "/api/files/[id]/route": "/api/files/[id]", "/api/files/list/route": "/api/files/list", "/api/files/delete/route": "/api/files/delete", "/api/files/rename/route": "/api/files/rename", "/api/files/restore/route": "/api/files/restore", "/api/files/serve/[...key]/route": "/api/files/serve/[...key]", "/api/files/statistics/route": "/api/files/statistics", "/api/projects/route": "/api/projects", "/api/files/upload/route": "/api/files/upload", "/api/proxy/route": "/api/proxy", "/api/users/route": "/api/users", "/_not-found/page": "/_not-found", "/api/debug/route": "/api/debug", "/(auth)/login/page": "/login", "/projects/[id]/page": "/projects/[id]", "/export-db/page": "/export-db", "/page": "/", "/slideshow/view/[projectId]/page": "/slideshow/view/[projectId]" };
